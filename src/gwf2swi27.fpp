! PREPROCESSOR MACRO TO SUBSTITUTE APPROPRIATE REAL TYPE FOR SOLVERS
! COMMENT OUT DEFINITION OF MFNWT (NEXT LINE) IF NOT MODFLOW-NWT
!#define MFNWT
#ifdef MFNWT
#define REAL_SWI DOUBLEPRECISION
#endif
#ifndef MFNWT
...
C         SWI PARAMETERS
        ...
        REAL_SWI, SAVE, DIMENSION(:,:,:), POINTER :: BRHS
        DOUBLE PRECISION, SAVE, DIMENSION(:,:), POINTER :: DUM
        REAL_SWI, SAVE, DIMENSION(:,:,:), POINTER :: RHSPRESWI
...
C           SWI PARAMETERS
          ...
          REAL_SWI, DIMENSION(:,:,:), POINTER :: BRHS
          DOUBLE PRECISION, DIMENSION(:,:), POINTER :: DUM
          REAL_SWI, DIMENSION(:,:,:), POINTER :: RHSPRESWI
