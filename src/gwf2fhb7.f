...
C
C4A-----READ CELL INDICES AND SPECIFIED-FLOW RATES
      IF(NFLW.LT.1) GO TO 70
      READ(IN,*) IFHBUN,CNSTM,IFHBPT
      WRITE(IOUT,50) IFHBUN,CNSTM
 50   FORMAT(/,1X,'CELL INDICES AND SPECIFIED-FLOW RATES ',
...
C5B------SPECIFIED-FLOW CELL LOCATIONS
 ...
 69   CONTINUE
C
C6------READ CELL INDICES AND SPECIFIED-HEAD VALUES
 70   IF(NHED.LT.1) GO TO 300
      READ(IN,*) IFHBUN,CNSTM,IFHBPT
      WRITE(IOUT,71) IFHBUN,CNSTM
 71   FORMAT(/,1X,'CELL INDICES AND SPECIFIED-HEAD VALUES ',
